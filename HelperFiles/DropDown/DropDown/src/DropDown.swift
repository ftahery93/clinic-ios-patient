...
public final class DropDown: UIView {
    ...
    public var isReversedAlignment: Bool? {
        didSet{
	...
	*/
	...
	//MARK: Constraints
	fileprivate var heightConstraint2: NSLayoutConstraint!
	fileprivate var widthConstraint2: NSLayoutConstraint!
	...
	*/
//    @objc public dynamic override var cornerRadius = DPDConstant.UI.CornerRadius {
//		willSet {
...
extension DropDown {
	...
	public override func updateConstraints() {
		...
		widthConstraint2.constant = layout.width
		heightConstraint2.constant = layout.visibleHeight
	...
	fileprivate func setupConstraints() {
		...
		widthConstraint2 = NSLayoutConstraint(
			item: tableViewContainer,
			attribute: .width,
			relatedBy: .equal,
			toItem: nil,
			...
			multiplier: 1,
			constant: 0)
		tableViewContainer.addConstraint(widthConstraint2)
		...
		heightConstraint2 = NSLayoutConstraint(
			...
			multiplier: 1,
			constant: 0)
		tableViewContainer.addConstraint(heightConstraint2)
...
extension DropDown: UITableViewDataSource, UITableViewDelegate {
	...
	fileprivate func configureCell(_ cell: DropDownCell, at index: Int) {
        ...
        cell.setRTL(reversed: isReversedAlignment)
